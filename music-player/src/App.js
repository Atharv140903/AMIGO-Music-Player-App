...
function App() {
  ...
  return (
    <div className="App m-20">
      <Header />
      <h2 className="mtb-20 app-quote">Find Music that Matches your Mood</h2>
      <SearchInput />
      <Tabs onItemSelect={onItemSelect} tabData= {appData['homeScreen']} />
      {list && <AudioList audioList={audioList} onTrackSelect
      ={onTrackSelect} onBackButtonPress={onBackButtonPress} />}
